...
function startGame() {
    myGamePiece = new component(80, 80, "/dist_all/isaacHead.png", 50, 50, "image");
...
function component(width, height, color, x, y, type) {
    ...
    this.kill = function () {
        this.rotate = 180;
        myGamePiece.image.src = "/dist_all/isaacDead.png";
...
function moveup() {
    if (myGameArea.controls) {
        ...
        myGamePiece.image.src = "/dist_all/isaacBlink.png";
    }
}
...
function clearThrust() {
    if (myGameArea.controls) {
        myGamePiece.gravity = 0.05;
        myGamePiece.image.src = "/dist_all/isaacHead.png";
    }
}
